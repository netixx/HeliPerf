package changeWin::ChargeandChange;
=pod
@description
...
@requires
	changeWin::Controller::on_toggled_radio
=cut
...
@requires
	changeWin::Controller::validerchangheli
=cut
sub changerheli {
...
@requires
	changeWin::Controller::annulerchangheli
=cut
sub annulerchange {
